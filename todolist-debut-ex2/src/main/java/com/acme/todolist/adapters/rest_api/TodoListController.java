...
public class TodoListController {
	...
	private AddTodoItemService addTodoItems;
	
	
	@Inject
	public TodoListController(GetTodoItems getTodoItemsQuery, AddTodoItemService addTodoItems) {
		this.getTodoItemsQuery = getTodoItemsQuery;
		this.addTodoItems = addTodoItems;
	}
